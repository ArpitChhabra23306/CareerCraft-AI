...
const FeatureCard = ({ icon: Icon, title, description, delay }) => (
    <Reveal delay={delay} className="group">
        <div className="relative h-full p-8 rounded-[20px] bg-[#fafafa] dark:bg-[#111] border border-[#f0f0f0] dark:border-[#1a1a1a] transition-all duration-500 hover:bg-white dark:hover:bg-[#151515] hover:shadow-[0_20px_60px_rgba(0,0,0,0.04)] dark:hover:shadow-[0_20px_60px_rgba(0,0,0,0.3)] hover:border-[#e8e8e8] dark:hover:border-[#222] hover:-translate-y-1">
...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-[#111] dark:text-[#eee] font-sans antialiased selection:bg-[#111] selection:text-white dark:selection:bg-white dark:selection:text-[#111] transition-colors duration-500">
            ...
            <section className="pt-40 pb-24 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <div className="w-1.5 h-1.5 rounded-full bg-[#111] dark:bg-[#eee]" />
                    ...
                    >
                        Learn Smarter.
                        <br />
                        <span className="text-[#bbb] dark:text-[#777]">Ace Every Interview.</span>
                    </motion.h1>
                    ...
                    >
                        <Link to={user ? '/dashboard' : '/register'} className="group bg-[#111] dark:bg-[#eee] text-white dark:text-[#111] px-8 py-3.5 rounded-xl text-[14px] font-semibold hover:bg-[#333] dark:hover:bg-[#ccc] transition-all duration-300 inline-flex items-center justify-center gap-2">
                            Start Learning Free
                            <ArrowRight size={16} className="group-hover:translate-x-0.5 transition-transform" strokeWidth={2} />
                        </Link>
                        <a href="#features" className="border border-[#eee] dark:border-[#222] text-[#666] dark:text-[#888] px-8 py-3.5 rounded-xl text-[14px] font-semibold hover:border-[#ccc] dark:hover:border-[#444] hover:text-[#111] dark:hover:text-[#eee] transition-all duration-300 inline-flex items-center justify-center gap-2">
            ...
            {/* ══ Divider ══ */}
            <div className="max-w-6xl mx-auto px-6"><div className="h-px bg-[#f5f5f5] dark:bg-[#141414]" /></div>
            ...
            <section id="how-it-works" className="py-28 px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                        <div className="hidden md:block absolute top-6 left-[20%] right-[20%] h-px bg-[#f0f0f0] dark:bg-[#1a1a1a]" />
                        {[
                            ...
                            <Reveal key={i} delay={i * 0.1} className="text-center">
                                <div className="w-12 h-12 mx-auto mb-6 rounded-full bg-[#fafafa] dark:bg-[#111] border border-[#f0f0f0] dark:border-[#1a1a1a] flex items-center justify-center">
            ...
            <section className="py-28 px-4">
                <Reveal>
                    <div className="max-w-3xl mx-auto text-center">
                        <div className="p-16 md:p-20 rounded-[28px] bg-[#111] dark:bg-[#eee]">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-3">
                                <Link to="/register" className="bg-white dark:bg-[#111] text-[#111] dark:text-[#eee] px-8 py-3.5 rounded-xl text-[14px] font-semibold hover:bg-[#f0f0f0] dark:hover:bg-[#222] transition-colors inline-flex items-center justify-center gap-2">
                                    Start Free Today
            ...
            {/* ══ FOOTER ══ */}
            <footer className="border-t border-[#f5f5f5] dark:border-[#141414]">
                <div className="max-w-6xl mx-auto px-6 py-16">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                        ...
                        {[
                            ...
                            <div key={i}>
                                <h4 className="text-[12px] font-semibold uppercase tracking-[0.1em] mb-4">{col.title}</h4>
                    ...
                    <div className="border-t border-[#f5f5f5] dark:border-[#141414] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
