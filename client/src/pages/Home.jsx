...
import { ArrowRight, BrainCircuit, FileText, Layers, MessageSquare, Zap } from 'lucide-react';
...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-800 font-sans selection:bg-indigo-100 selection:text-indigo-700">
            {/* Navbar */}
            ...
            <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
                    ...
                    <div className="absolute top-20 -left-20 w-96 h-96 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
            ...
            <section className="py-20 bg-gray-50/50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        />
                        <FeatureCard
                            icon={Zap} // Replaced BrainCircuit for variety if needed, or stick to BrainCircuit
            ...
            <footer className="bg-white border-t border-gray-100 py-12">
                <div className="max-w-7xl mx-auto px-4 text-center text-gray-500">
                    <div className="flex justify-center items-center gap-2 mb-4">
                        ...
                        <span className="text-lg font-bold text-gray-800">AI Learn</span>
                    </div>
