...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-96 h-96 bg-indigo-200 dark:bg-indigo-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-50 dark:opacity-30 -translate-y-1/2 translate-x-1/2"></div>
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-200 dark:bg-purple-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-50 dark:opacity-30 translate-y-1/2 -translate-x-1/2"></div>
            ...
            >
                ...
                <p className="text-gray-500 dark:text-gray-400 text-center mb-6">Sign in to continue your learning journey</p>
                ...
                <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <Link to="/register" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-medium transition-colors">
                        Register
                    </Link>
                </p>
            </motion.div>
