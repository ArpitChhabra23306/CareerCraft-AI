        ...
        <div className="min-h-screen flex bg-[#F5F2EA] dark:bg-[#0F1115] transition-colors duration-500">
            ...
            <div className="flex-1 flex items-center justify-center p-8 relative">
                ...
                >
                    ...
                    {/* Header */}
                    <div className="mb-8">
                        <h2 className="text-2xl font-bold text-[#0F1115] dark:text-[#F5F2EA] tracking-[-0.03em]">Sign in</h2>
                        <p className="text-[#8D8474] text-[13px] mt-2">Enter your credentials to access your account</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="flex justify-end mt-1.5">
                                <Link
                                    to="/forgot-password"
                                    className="text-[12px] text-[#8D8474] hover:text-[#0F1115] dark:hover:text-[#F5F2EA] transition-colors"
                                >
                                    Forgot password?
                                </Link>
                            </div>
                    ...
                    <div className="mt-8">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-[12px]">
                                <span className="px-4 bg-[#F5F2EA] dark:bg-[#0F1115] text-[#B8B1A3] dark:text-[#8D8474]">New to CareerCraft AI?</span>
                            </div>
                        </div>
                        <Link
                            to="/register"
